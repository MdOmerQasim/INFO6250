...
<%-- 	<div style="padding:50px">
      ...
      <h1>Total Users..... <%=request.getAttribute("patientCount")%>  </h1>
      <h1>Total Admins..... <%=request.getAttribute("adminCount")%>  </h1>
      <h1>Total Doctors..... <%=request.getAttribute("doctorCount")%>  </h1>
      <h1>Appointments..... <%=request.getAttribute("apptCount")%>  </h1>
            ...
            <div class="card-body">
              <div class="media d-flex">
                ...
                <div class="media-body text-right">
                  <h3><%=request.getAttribute("patientCount")%></h3>
                  <span>Users</span>
                </div>
              </div>
            </div>
          ...
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                ...
                <div class="media-body text-right">
                  <h3><%=request.getAttribute("doctorCount")%></h3>
                  <span>Doctors</span>
                </div>
              </div>
            </div>
