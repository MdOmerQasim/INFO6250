...
<body>
	...
	<div class="login-page alignleft">
	    ...
	    <div class="form">
		<form action="userProfile?action=editProfile" method="post">
			...
			<input title="Cannot update username (Contact admin)" type="text" id="username" name="username" class="form-control" value="<%= ((UserSession)session.getAttribute("userSession")).getUsername()%>" disabled> 
			<input title="Enter email" type="email" id="email" name="email" class="form-control" value="<%= session.getAttribute("email") %>" required> 
			<input type="tel" id="lastname" name="lastname" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="phone number" value="<%= session.getAttribute("telNum") %>" required>
	...
	<div class="login-page alignright">
	    ...
	    <div class="form">
		<form action="userProfile?action=editProfilePassword" method="post">
