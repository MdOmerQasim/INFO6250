...
public class AdminProfile extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<UserRegistration> userData = user.viewAllUsers("ADMIN");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if("editProfile".equals(request.getParameter("action"))){
			...
			RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/admin/profile.jsp");
			...
			if(!newPassword.equals(confirmPassword)) {
				...
				request.getRequestDispatcher("/WEB-INF/admin/passwordStatus.jsp").forward(request, response);
			}
		}
	}
