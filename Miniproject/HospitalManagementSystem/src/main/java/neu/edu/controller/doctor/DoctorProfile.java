...
public class DoctorProfile extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<UserRegistration> userData = user.viewAllUsers("DOCTOR");
		...
		request.getRequestDispatcher("/WEB-INF/doctor/profile.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if("editProfile".equals(request.getParameter("action"))){
			...
			RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/doctor/profile.jsp");
			...
			if(!newPassword.equals(confirmPassword)) {
				...
				request.getRequestDispatcher("/WEB-INF/doctor/passwordStatus.jsp").forward(request, response);
			}
		}
	}
